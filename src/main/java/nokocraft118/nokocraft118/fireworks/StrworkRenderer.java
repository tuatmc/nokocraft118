...
@OnlyIn(Dist.CLIENT)
public class StrworkRenderer extends EntityRenderer<StrworkEntity> {
    private final ItemRenderer itemRenderer;

    public StrworkRenderer(EntityRendererProvider.Context p_174114_) {
        super(p_174114_);
        this.itemRenderer = p_174114_.getItemRenderer();
    }

    public void render(StrworkEntity p_114656_, float p_114657_, float p_114658_, PoseStack p_114659_, MultiBufferSource p_114660_, int p_114661_) {
        p_114659_.pushPose();
    ...
    public ResourceLocation getTextureLocation(StrworkEntity p_114654_) {
